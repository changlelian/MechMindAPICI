            ...
            stage('Test cpp camera interface in linux') {
                    steps {
                        script {
                            ...
                            sh 'sudo docker exec APITestCameraInterface /home/MMIND_TEST_CI_main/MechEyeCppAutoTestProject/src/build/MechEyeCppAutoTestProject --gtest_filter=*Camera* --ip=192.168.20.198'
